        ...
        <div className="h-screen bg-gradient-to-tr from-white to-blue-300">
            ...
            <div className='p-5 grid grid-cols-3 divide-x'>
                ...
                <div class="container py-10 px-10 mx-0 min-w-full flex flex-col items-center">
                    ...
                    <button type="button" className="focus:outline-none text-white bg-blue-500 hover:bg-blue-500 focus:ring-4 focus:ribg-blue-500 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-green-800">
